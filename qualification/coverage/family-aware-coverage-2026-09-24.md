...
Every recipe and Model document is validated through the canonical contract; its content digest must match both the producer index and the authored tree document. The current indexed package is checked against its declared size and SHA-256, then validated through the canonical package validator. Authored-source consistency remains the `tools/build-catalog-index --check` gate.
`runtime_stack_sha256` binds the full runtime/build contract and the bytes/modes of every selected regular file in the digest-verified recipe package at the accepted catalog commit.
The catalog `source_commit` is provenance metadata, not the source-byte authority. Published identities use each package blob pinned by the catalog commit; current indexed package identities use the local package after its size, digest and canonical closure validate.
...
| 18 | `vonk-forge/ltx-2-19b-dev-bf16-diffusers-single` | 1 | `image-video-workflows` | `pytorch-pipeline` | `nvcr.io/nvidia/cuda@a52783d8d73a` | `adapters/video/ltx23-sync-native-disk` | ltx | none | 93.8 GiB | vonk-forge/ltx-2-3-22b-distilled-1-1-diffusers-single | batch-009/L2 | yes |
...
| 24 | `vonk-forge/ltx-2-3-22b-distilled-1-1-diffusers-single` | 1 | `image-video-workflows` | `pytorch-pipeline` | `nvcr.io/nvidia/cuda@a52783d8d73a` | `adapters/video/ltx23-sync-native-disk` | ltx | none | 89.3 GiB | yes | batch-012/L2 | yes |
...
| 26 | `vonk-forge/ltx-2-19b-distilled-fp8-diffusers-single` | 1 | `image-video-workflows` | `pytorch-pipeline` | `nvcr.io/nvidia/cuda@a52783d8d73a` | `adapters/video/ltx2-sync-native` | ltx | fp8-scaled-mm, none | 71.6 GiB | yes | batch-013/L2 | yes |
...
| 40 | `vonk-forge/ltx-2-19b-distilled-diffusers-single` | 1 | `image-video-workflows` | `pytorch-pipeline` | `nvcr.io/nvidia/cuda@a52783d8d73a` | `adapters/video/ltx2-sync-native` | ltx | none | 86.7 GiB | yes | batch-020/L2 | yes |
...
| `0ae990b797516092` | `vllm` | `vonk-forge/glm-5-3-flash-nvfp4-vllm-dual` | 1 | 181.3 GiB |
| `147d3f2f03dc7175` | `specialized-fork-engines` | `vonk-forge/deepseek-v4-flash-0731-mia-dual` | 1 | 155.4 GiB |
| `184fd456790270f4` | `image-video-workflows` | `vonk-forge/ltx-2-19b-distilled-fp8-diffusers-single` | 1 | 71.6 GiB |
...
| `23ebc26e03abc101` | `specialized-fork-engines` | `vonk-forge/glm-5-3-flash-nvfp4-ablit-l15-43-dflash2-vllm-dual` | 1 | 188.7 GiB |
...
| `3136946bbfb935ef` | `image-video-workflows` | `vonk-forge/ltx-2-19b-distilled-diffusers-single` | 1 | 86.7 GiB |
...
| `42630af5e6f8f3e0` | `vllm` | `vonk-forge/qwen3-8-27b-fp8-vllm-single` | 1 | 28.8 GiB |
...
| `47d792f6a77d9c0d` | `image-video-workflows` | `vonk-forge/ltx-2-5-22b-distilled-bf16-diffusers-single` | 1 | 65.3 GiB |
| `4cb8319ea6b94858` | `vllm` | `vonk-forge/lfm2-5-vl-3b-vllm-single` | 1 | 5.8 GiB |
| `4ea8811380260dbd` | `vllm` | `vonk-forge/qwen3-6-27b-vllm-single` | 1 | 51.8 GiB |
...
| `5ae7b137a1ccdd63` | `image-video-workflows` | `vonk-forge/ltx-2-3-22b-distilled-1-1-diffusers-single` | 2 | 89.3 GiB |
| `5b33f4dbba43faef` | `vllm` | `vonk-forge/nemotron-3-nano-omni-30b-a3b-vllm-single` | 1 | 20.9 GiB |
| `5c702cffe62f6dd5` | `sglang` | `vonk-forge/qwen3-8-flash-next-nvfp4-sglang-dual` | 1 | 126.0 GiB |
| `5f8e69fac5786b3a` | `three-d-pipelines` | `vonk-forge/triposg-pytorch-single` | 1 | 7.6 GiB |
| `60503cb615fc1cf2` | `sglang` | `vonk-forge/ling-3-0-flash-dspark-sglang-single` | 1 | 74.3 GiB |
...
| `791167bd703caabb` | `vllm` | `vonk-forge/qwen3-8-flash-next-nvfp4-vllm-dual` | 1 | 126.0 GiB |
| `7bc249e34dbd1eee` | `image-video-workflows` | `vonk-forge/wan-dancer-14b-pytorch-single` | 1 | 79.8 GiB |
| `7dbaf14e160e9b08` | `vllm` | `vonk-forge/ui-mate-27b-vllm-single` | 1 | 51.0 GiB |
...
| `8b361633547a9658` | `sglang` | `vonk-forge/qwen3-8-27b-nvfp4-dspark-sglang-single` | 1 | 25.6 GiB |
| `93bc085c38b2a0b8` | `specialized-fork-engines` | `vonk-forge/deepseek-v4-flash-vision-exp-mia-dual` | 1 | 156.3 GiB |
...
| `a4fc947c813c1c49` | `specialized-fork-engines` | `vonk-forge/glm-5-3-flash-nvfp4-kv-1m-abliterated-vllm-dual` | 1 | 181.3 GiB |
...
| `b9c1d6778145dd32` | `specialized-fork-engines` | `vonk-forge/glm-5-3-flash-exl3-dflash2-vllm-dual` | 1 | 168.0 GiB |
| `c0380c9df0146da2` | `image-video-workflows` | `vonk-forge/qwen-image-edit-2511-comfyui-single` | 1 | 47.0 GiB |
| `c44c3b7b9cea5911` | `image-video-workflows` | `vonk-forge/ltx-2-5-22b-distilled-fp8-cast-diffusers-single` | 1 | 65.3 GiB |
...
| `d48a07ced5e0508d` | `specialized-fork-engines` | `vonk-forge/deepseek-v4-flash-0731-mia-sparkinfer-single` | 1 | 99.5 GiB |
...
| `e376a93ade9ad098` | `sglang` | `vonk-forge/inkling-small-nvfp4-sglang-dual` | 1 | 159.0 GiB |
| `e688db8e562495cb` | `vllm` | `vonk-forge/qwen3-8-27b-vllm-single` | 1 | 51.8 GiB |
...
|---|---|---|---:|---|---|
| `d898184858b022af` | `dual-host-restart` | `vonk-forge/qwen3-8-flash-next-nvfp4-sglang-dual` | 1 | no | n/a |
| `588957170fde7129` | `dual-host-restart` | `vonk-forge/glm-5-3-flash-nvfp4-kv-1m-abliterated-vllm-dual` | 1 | no | n/a |
| `39816cadd4a85ef3` | `dual-host-restart` | `vonk-forge/deepseek-v4-flash-vision-exp-mia-dual` | 1 | no | n/a |
| `f41e0612d88f2c3d` | `dual-host-restart` | `vonk-forge/glm-5-3-flash-nvfp4-vllm-dual` | 1 | no | n/a |
| `0843c9963e0a6682` | `dual-host-restart` | `vonk-forge/deepseek-v4-flash-0731-mia-dual` | 1 | no | n/a |
| `fb7920a1f70f4616` | `dual-host-restart` | `vonk-forge/glm-5-3-flash-nvfp4-ablit-l15-43-dflash2-vllm-dual` | 1 | no | n/a |
| `995f6e1a20b7520c` | `dual-host-restart` | `vonk-forge/inkling-small-nvfp4-sglang-dual` | 1 | no | n/a |
| `b6768300095b91d5` | `dual-host-restart` | `vonk-forge/qwen3-8-flash-next-nvfp4-vllm-dual` | 1 | no | n/a |
| `2270742c1c0db40b` | `dual-host-restart` | `vonk-forge/glm-5-3-flash-exl3-dflash2-vllm-dual` | 1 | no | n/a |
| `ac24437b055e67f9` | `dual-rank-loss-recovery` | `vonk-forge/qwen3-8-flash-next-nvfp4-sglang-dual` | 1 | no | n/a |
| `b191f68e7d80356d` | `dual-rank-loss-recovery` | `vonk-forge/glm-5-3-flash-nvfp4-kv-1m-abliterated-vllm-dual` | 1 | no | n/a |
| `f974bfa5c18609bf` | `dual-rank-loss-recovery` | `vonk-forge/deepseek-v4-flash-vision-exp-mia-dual` | 1 | no | n/a |
| `64a10e7879f82c5d` | `dual-rank-loss-recovery` | `vonk-forge/glm-5-3-flash-nvfp4-vllm-dual` | 1 | no | n/a |
| `2ae1b792b2ad6d13` | `dual-rank-loss-recovery` | `vonk-forge/deepseek-v4-flash-0731-mia-dual` | 1 | no | n/a |
| `bac87c73dfbb7ce7` | `dual-rank-loss-recovery` | `vonk-forge/glm-5-3-flash-nvfp4-ablit-l15-43-dflash2-vllm-dual` | 1 | no | n/a |
| `d6422305062b52f8` | `dual-rank-loss-recovery` | `vonk-forge/inkling-small-nvfp4-sglang-dual` | 1 | no | n/a |
| `6f468d3fdffef1c6` | `dual-rank-loss-recovery` | `vonk-forge/qwen3-8-flash-next-nvfp4-vllm-dual` | 1 | no | n/a |
| `845a428566ea3af3` | `dual-rank-loss-recovery` | `vonk-forge/glm-5-3-flash-exl3-dflash2-vllm-dual` | 1 | no | n/a |
...
| `9052ad1694d15885` | `single-host-restart` | `vonk-forge/deepseek-v4-flash-0731-mia-sparkinfer-single` | 1 | no | n/a |
| `f00b7407b4dbe383` | `single-host-restart` | `vonk-forge/qwen-image-2512-lightning-diffusers-single` | 1 | no | n/a |
| `e42d3d84339b165c` | `single-host-restart` | `vonk-forge/qwen3-8-27b-nvfp4-dspark-sglang-single` | 1 | no | n/a |
...
| `20d38dc16bf26303` | `single-host-restart` | `vonk-forge/ling-3-0-flash-dspark-sglang-single` | 1 | no | n/a |
| `3e17ae83ca97901b` | `single-host-restart` | `vonk-forge/ltx-2-19b-dev-bf16-diffusers-single` | 1 | no | n/a |
| `6973b77549c1030c` | `single-host-restart` | `vonk-forge/ltx-2-3-22b-distilled-1-1-diffusers-single` | 1 | no | n/a |
| `cb4fcb42262e5244` | `single-host-restart` | `vonk-forge/laguna-s-2-1-nvfp4-vllm-single` | 1 | no | n/a |
| `190d08f5f25c5619` | `single-host-restart` | `vonk-forge/ltx-2-19b-distilled-fp8-diffusers-single` | 1 | no | n/a |
| `2e276f137543ce53` | `single-host-restart` | `vonk-forge/ltx-2-19b-distilled-diffusers-single` | 1 | no | n/a |
...
| `6d06c51d57622fa4` | `single-host-restart` | `vonk-forge/ltx-2-5-22b-distilled-fp8-cast-diffusers-single` | 1 | no | n/a |
| `9234d31d40d27076` | `single-host-restart` | `vonk-forge/deepseek-v4-flash-0731-ds4-single` | 1 | no | n/a |
| `625c425874376f74` | `single-host-restart` | `vonk-forge/qwen3-6-27b-vllm-single` | 1 | no | n/a |
...
| `b61057454a1f90d7` | `single-host-restart` | `vonk-forge/qwen3-8-27b-fp8-vllm-single` | 1 | no | n/a |
...
| `237960bdfd01abb8` | `single-host-restart` | `vonk-forge/qwen3-8-27b-vllm-single` | 1 | no | n/a |
| `ef77713db5331b39` | `single-host-restart` | `vonk-forge/ui-mate-27b-vllm-single` | 1 | no | n/a |
...
| `0b55f77341493cb6` | `single-host-restart` | `vonk-forge/ltx-2-5-22b-distilled-bf16-diffusers-single` | 1 | no | n/a |
