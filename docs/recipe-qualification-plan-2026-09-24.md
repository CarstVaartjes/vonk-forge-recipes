...
it binds the 85-recipe v1.0.12 catalog from tag `v1.0.12` (catalog source
`88f33f9a661d86bbf1a30c9c9b90e5c7e6d02593`, release commit
`bd082ffa645e911f54156e25043be4efca095c30`) and lists every 1- or 2-Spark
