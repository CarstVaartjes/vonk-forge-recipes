...
it binds the 85-recipe v1.0.10 catalog from tag `v1.0.10` (catalog source
`0d420583bea8e2e9c36c061700cefe3d9b7d38c1`, release commit
`addb7dbfc71515417df84327d005f6ef20d14d4c`) and lists every 1- or 2-Spark
