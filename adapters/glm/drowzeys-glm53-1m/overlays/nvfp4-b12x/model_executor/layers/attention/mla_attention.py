...
class MLAAttention(nn.Module, AttentionLayerBase):
    ...
    def get_kv_cache_spec(self, vllm_config: VllmConfig) -> KVCacheSpec:
        ...
        _mt = getattr(vllm_config.model_config.hf_config, "model_type", None)
        _glm_fp8_rope = bool(
            os.environ.get("KV_FP8_ROPE", "0") == "1"
            and self.kv_cache_dtype == "nvfp4_ds_mla"
            and _mt in ("glm_moe_dsa", "glm5_next")
        )  # glm53 nvfp4 port: B12X 368-B fp8-RoPE record
        return MLAAttentionSpec(
            model_version="glm_fp8_rope" if _glm_fp8_rope else None,
            **common_kwargs,
