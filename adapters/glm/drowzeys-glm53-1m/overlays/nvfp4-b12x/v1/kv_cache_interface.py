...
class MLAAttentionSpec(FullAttentionSpec):
    ...
    def real_page_size_bytes(self) -> int:
        if self.cache_dtype_str == "nvfp4_ds_mla":
            # B12X NVFP4 MLA record: 432 B/token (256B E2M1 NoPE + 32B E4M3
            # group-16 scales + 16B pad + 128B BF16 RoPE). [glm53 nvfp4 port]
            if getattr(self, "model_version", None) == "glm_fp8_rope":
                return self.block_size * 368  # KV_FP8_ROPE=1 record
